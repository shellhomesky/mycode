...
if __name__ == '__main__':
    ...
    pdx = pd.DataFrame(columns=(
        ...
        'plannumupdown', 'xuezi', 'xuefei', 'xuancei', 'sid', 'speccode', 'scateid', 'stypebig', 'stypesmall',
        'plannum',
        'lqnum', 'maxscore', 'minscore', 'minscoreminus', 'segmentposition', 'segmenttotalman', 'linescore',
        'zypingxing',
        'zyzhengqiu', 'zyfucong', 'lastplannum', 'lastlqnum', 'lastmaxscore', 'lastminscore', 'lastminscoreminus',
        'lastsegmentposition', 'lastsegmenttotalman', 'lastlinescore', 'lastzypingxing', 'lastzyzhengqiu',
        'lastzyfucong',
